...
class PagesModel extends Model{
    ...
    public function __construct(){
        ...
        $this->list[] = Listify::column('cell')->field('name')->header('pages');
        $this->list[] = Listify::column('cell')->field('slug')->header('Slugs');
        $this->list[] = Listify::column('modify', ['path' => Config::get('site/uri').'/admin/page','id'])->header('Modify');
    ...
    public function all(){
        ...
        $this->pages = Sequel::select('pages')
                ->do();
    ...
    public function grab($val, $field = 'id'){
        ...
        $this->single = Sequel::select('pages')
                ->where($field, '=', $val)
                ->do();
